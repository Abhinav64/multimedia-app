...
export default function App() {
 ...
 function generateShareUrl(filePath) {
 
  const baseUrl = 'https://example.com/share-file/';
  return baseUrl + encodeURIComponent(filePath);
}
function shareFile(shareUrl) {
  const subject = 'Check out this file';
  const body = `I wanted to share this file with you: ${shareUrl}`;
...
function printFile(filePath) {
 ...
 return (
  ...
  onClick={() => {
    if (selectedFile) {
      const shareUrl = generateShareUrl(selectedFile.path); 
